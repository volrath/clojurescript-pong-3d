...
(def plane-geometry (js/THREE.PlaneBufferGeometry. (* 0.95 (:width field-size)) (:height field-size) 10 10))
...
(def table-geometry (js/THREE.BoxGeometry. (* 1.05 (:width field-size)) (* 1.03 (:height field-size)) 100 10 10 1))
...
(def ground-geometry (js/THREE.BoxGeometry. 1000 1000 3 1 1 1))
...
(def pillar-geometry (js/THREE.BoxGeometry. 30 30 300 1 1 1))
...
(def paddle-1-geometry (js/THREE.BoxGeometry. paddle-width paddle-height paddle-depth paddle-quality paddle-quality))
...
(def paddle-2-geometry (js/THREE.BoxGeometry. paddle-width paddle-height paddle-depth paddle-quality paddle-quality))
